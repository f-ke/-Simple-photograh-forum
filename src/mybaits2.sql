...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mybaits` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
insert  into `userfollowers`(`userid`,`followerid`,`userfollowerid`) values (6,1,12),(6,2,13),(6,3,14),(8,1,15),(8,2,16),(9,1,18);
...
insert  into `users`(`userName`,`id`,`passWord`,`email`,`gender`,`vocation`,`religion`,`city`,`hometown`,`state`,`birthyear`,`birthmonth`,`birthday`,`userimage`) values ('fanfan',1,'123456','123@qq.com',0,'engineer','none',NULL,NULL,NULL,1997,1,27,'/asserts/img/our.svg'),('fanfan2',2,'1234567','123@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/asserts/img/our.svg'),('fanfan21',3,'12345678','123@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/asserts/img/our.svg'),('fanfan223',4,'123456','123@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/asserts/img/our.svg'),('fanfan123000',5,'12345','123@qq.com',0,'engineer','re',NULL,NULL,NULL,1997,1,27,'/asserts/img/our.svg'),('lindong',6,'hahaha','123@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/asserts/img/our.svg'),('aaaa',7,'122222','123@qq.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'/asserts/img/our.svg'),('fanfan12345',8,'123456','156789@qq.com',0,'engineer','',NULL,NULL,NULL,0,0,0,'/asserts/img/our.svg'),('andy',9,'123456','123@qq.com',0,'engineer','',NULL,NULL,NULL,0,0,0,'/asserts/img/our.svg');
...
insert  into `usertopics`(`id`,`userid`,`topictext`,`usertopicid`) values (2,1,'activities',2),(3,1,'families',3),(4,1,'movies',4),(4,2,'movies',6),(2,5,'activities',8),(1,6,'meals',10),(1,8,'meals',11),(2,8,'activities',12),(1,9,'meals',14);
